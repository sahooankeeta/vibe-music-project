...
const Auth = () => {
  ...
  return (
    <div className='flex w-[100vw] h-[100vh] justify-center items-center bg-svg bg-slate-900'>
      ...
      <div className="mt-1">
        <input required onChange={handleChange} value={form.password} type="password" minLength={6} name="password" id="password" placeholder="Password" className="px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1 disabled:shadow-none"/>
      </div>
    </div>}
    {authType==='signup' &&
    <div className="mt-6">
